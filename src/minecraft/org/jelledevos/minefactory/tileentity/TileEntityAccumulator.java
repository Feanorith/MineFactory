...
public class TileEntityAccumulator extends TileEntity
{
...
//    	System.out.println("Current Power: " + accumulatorCurrentStorage);
...
//        }
	...
	public void receiveEnergy(int i) {
		accumulatorCurrentStorage = accumulatorCurrentStorage + 5;
	}
	
	@Override
	public String toString() {
		return "Accumulator[" + xCoord + ", " + yCoord + ", " + zCoord + "]";
	}
}
